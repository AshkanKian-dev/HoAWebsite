...
const { createUser, getUserByEmail, getUserById, updateUserLastLogin, updateUserPassword, createPasswordResetToken, getPasswordResetToken, markPasswordResetTokenAsUsed } = require('../database/db');
